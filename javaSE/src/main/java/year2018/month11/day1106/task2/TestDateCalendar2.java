...
public class TestDateCalendar2 {
    public static void main(String args[]) {
        ...
        int month = now.get(Calendar.MONDAY) + 1;// 月份
        ...
        /*
        代码1：sdf.format(today)
        代码2：currentTimeMillis()
        代码3：sdf.format(tomorrow)
        代码4：Calendar.YEAR
        代码5：Calendar.MONDAY
        代码6：Calendar.DAY_OF_WEEK
         */
    }
